...
//                ZogUtils.i( "top refresh content:" + content);
        ...
        webView.setWebScrollListener(new LoadMoreWebView.WebScrollListener() {
            @Override
            public void onTop() {
//                ZogUtils.i(WebActivity.class, "onTop onTop onTop onTop");
...
//                ZogUtils.i(WebActivity.class, "onCenter onCenter onCenter onCenter");
...
//                ZogUtils.i(WebActivity.class, "onBottom onBottom onBottom onBottom");
...
//                ZogUtils.i(WebActivity.class, "onScrolling onScrolling onScrolling onScrolling");
                if (webScrollListener != null)
...
//                ZogUtils.e(WebFragment.class, "title title title:" + title);
                setWebTitle(title);
...
//
//                ZogUtils.e(WebViewUtils.class, "toggledFullscreen:" + fullscreen);
//                if (fullscreen) {
//
...
//            ToastUtils.mkLongTimeToast(getActivity(),getString(ResourceUtils.getStringId(getApplication(),"empty_url")));
    ...
    private void startTimerTask() {
        cancelTimer();
        //LogUtils.i(getClass(), "startTimerTask");
        task = new TimerTask() {
            public void run() {
        ...
        if (!ListUtils.isNullOrContainEmpty(cks)) {
            for (int i = 0; i < cks.size(); i++) {
                ...
                String cookieStr = cookie.getName() + "=" + cookie.getValue() + ";"
                        ...
                        + "path=/";
//                ZogUtils.e(WebFragment.class, "set cookie string:" + cookieStr);
